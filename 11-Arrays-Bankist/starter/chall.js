...
const checkDogs = function (dogsJulia, dogsKate) {
  const actDogsJulia = dogsJulia.slice(1, -2);

  // 2. Create an array with both Julia's (corrected) and Kate's data
  const dogs = actDogsJulia.concat(dogsKate);
...
const agesDog1 = [16, 6, 10, 5, 6, 1, 4];
...
console.log(calcAverageHumanAge(agesDog));

console.log(calcAverageHumanAge(agesDog1));
...
// food portion and add it to the object as a new property. Do not create a new array, simply loop
// over the array. Forumla: recommendedFood = weight ** 0.75 * 28. (The result is in grams of food,
